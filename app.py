...
from modulos_farmacia.farmacia_logs import farmacia_logs_bp
from modulos_farmacia.administrar_cenefas_farmacia import administrar_cenefas_farmacia_bp

app = Flask(__name__)
app.secret_key = "clave_secreta_demo"

app.register_blueprint(administrar_cenefas_farmacia_bp)
